...
public class ShareDialog extends Dialog implements View.OnClickListener, WbShareCallback, Listener<byte[]>, ErrorListener {
    ...
    public ShareDialog(Context context) {
        ...
        for (int i = 0; i < icons.length; i++) {
            ...
            tv.setBackgroundResource(R.drawable.highlight_bkg);
...
//        }
    ...
    private void sendToQQFriends() {
        ...
        args.putString(QQShare.SHARE_TO_QQ_SUMMARY, mFeed.desc);
        args.putString(QQShare.SHARE_TO_QQ_TARGET_URL, mFeed.url);
    ...
    private void sendToQzone() {
        ...
        args.putString(QzoneShare.SHARE_TO_QQ_SUMMARY, mFeed.desc);
        args.putString(QzoneShare.SHARE_TO_QQ_TARGET_URL, String.format("http://www.u148.net/article/%1$s.html", mFeed.url));
    ...
    private void sendWebPage(int type, Bitmap bitmap) {
        ...
        WXWebpageObject webObject = new WXWebpageObject(mFeed.url);
        WXMediaMessage msg = new WXMediaMessage(webObject);
        msg.title = mFeed.title;
        String desc = mFeed.desc;
